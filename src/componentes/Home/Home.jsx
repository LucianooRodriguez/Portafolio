                    ...
                    <div class="row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <div class="bloque1 card">
                                <div class=" card-body">
                                    <img class="fotoPerfil" src="public\imagenes\FotoPerfil.jpg" alt="FotoPerfil" />
                                    ...
                                    <Link to={"https://api.whatsapp.com/send/?phone=1122445079&text&type=phone_number&app_absent=0"} >     
                                        <img className="whatsapp1" src="./public/imagenes/whatsapp.png" alt="" />
                                    </Link>
                                    <Link to={"https://www.linkedin.com/in/luciano-rodriguez-bb2174269/"} >     
                                        <img className="linkedin1" src="./public/imagenes/linkedin.png" alt="" />
                                    </Link>

                                    <Link to={"https://github.com/LucianooRodriguez"} >     
                                        <img className="git1" src="./public/imagenes/github.png" alt="" />
                                    </Link>
                                </div>
                            </div>
                        </div>
